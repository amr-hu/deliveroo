...
Feature: Careers Feature
  ...
  Scenario: TC_003 - Apply for a career and fill the application form with only mandatory fields
  ...
  Scenario: TC_004 - Apply for a career and fill the application form with all fields and attached CV and cover letter
    Given user navigates to the homepage
    And clicks on the 'Careers' link at the footer
    When user clicks on career card with 'Lead Network Engineer' at 'London, London' in 'Operations Team'
  ...
  Scenario: TC_005 - Apply for a career and fill the application form with all fields and written CV and cover letter
    Given user navigates to the homepage
    And clicks on the 'Careers' link at the footer
    When user clicks on career card with 'Lead Network Engineer' at 'London, London' in 'Operations Team'

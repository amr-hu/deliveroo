...
Feature: Deliveroo For Work Feature
  ...
  Scenario: TC_001 - Deliveroo For Work scenario with only mandatory fields
  ...
  Scenario: TC_002 - Deliveroo For Work scenario with all fields and all the employees are added manually
    Given user navigates to the homepage
    And clicks on 'Deliveroo for Work' card

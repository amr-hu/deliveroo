...
public class ExtentReportUtil {
    ...
    /**
     * This method is used to initialize the html report that will be used to log the test case executions
     *
     * @param htmlReportPath       the path of the generated html report
     * @param htmlReportConfigPath the path of the configuration xml file for the html report
     */
    ...
    /**
     * This method is used to flush the html report with all the executed scenarios results
     */
